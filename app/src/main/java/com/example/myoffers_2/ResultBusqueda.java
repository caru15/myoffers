 ...
 * Use the {@link ResultBusqueda#newInstance} factory method to
...
public class ResultBusqueda extends Fragment {
     ...
     * @return A new instance of fragment ResultBusqueda.
     */
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        String[] prod=ResultBusquedaArgs.fromBundle(getArguments()).getProductos();
